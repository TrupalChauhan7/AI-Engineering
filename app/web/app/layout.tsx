...
export const metadata: Metadata = {
  ...
  description:
    "Turns a consultation recording into a SOAP note, then verifies every claim against the transcript and raises an alarm on the notes that need a second look.",
};
